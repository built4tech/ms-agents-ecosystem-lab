...
# Establecimiento de la raiz del proyecto para cargar el .env
#   - parents[5] asume la estructura del repo, indicando que el codigo del agente está a 5 niveles de la raiz
...
class SimpleChatAgent(AgentInterface):
    ...
    def __init__(self) -> None:
        ...
        # en vez de ello, llamar a initialize desde el código que instancia el agente, en este caso desde main.py o cli.py, esto permite que la inicialización del agente se realice de manera asíncrona y no bloquee la ejecución del programa.
    ...
    async def initialize(self) -> None:
        ...
        logger.debug(f"Cargando .env desde {PROJECT_ROOT / '.env'}")
